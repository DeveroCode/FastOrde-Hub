        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-100 border-b">
                ...
                <td class="px-6 py-4 text-sm text-gray-800">
                    <span
                        class="{{ $food->is_available ? 'text-green-600 bg-green-200' : 'text-red-600 bg-red-200' }} text-xs font-medium rounded-full py-1 px-4">
                ...
                <td class="px-6 py-4 text-sm text-gray-800 flex justify-between">
                    ...
                    <button wire:click="change({{ $food->id }})">
                    ...
                    <button wire:click="delete({{ $food->id }})">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
