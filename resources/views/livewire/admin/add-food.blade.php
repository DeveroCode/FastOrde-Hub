<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:my-auto lg:max-w-7xl flex gap-10 mb-32 py-32">
    <div class="bg-white rounded-md shadow-xl w-[50%] px-4">
        <div class="w-full md:w-2/3">
            <h2 class="text-2xl font-semibold text-gray-600 mb-4 pt-10">Registro de nuevo alimento</h2>
            <form enctype="multipart/form-data" wire:submit.prevent="create" class="space-y-6">
                <div class="space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <textarea type="text" id="descripción"
                        class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full h-32"
                        wire:model='descripción' name="descripción" :value="old('descripcion')" autofocus
                        autocomplete="descripción" placeholder="Descripción del platillo, postres, comida"></textarea>
    ...
    <div class="w-[50%] p-5">
        ...
        <div
            ...
            <div class="bg-gray-50 p-4 rounded-md">
                @if($imagen)
                <img src="{{ $imagen->temporaryUrl() }}" alt="{{ $name }}"
